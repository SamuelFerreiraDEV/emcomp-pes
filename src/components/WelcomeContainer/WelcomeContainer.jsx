...
export function WelcomeContainer() {
  ...
  return (
    <div className="welcome-container -mt-[6vh] flex justify-evenly">
      <div className="text-container flex flex-col items-center justify-center gap-2 xl:gap-6 text-center leading-tight text-black70">
        <h1 className="text-[0.75rem] xl:text-4xl text-theme">
          Bem-vindo a nossa{" "}
          <strong>
            Plataforma de <br />
        ...
        <HomeButton sizeClass={screenSize < 768 ? "mobile_md": "md"} text={"Veja como"} />
      </div>
